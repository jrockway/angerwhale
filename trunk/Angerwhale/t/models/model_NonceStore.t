...
use ok 'Angerwhale::Model::NonceStore';
use Test::MockObject;
...
my $ns = Angerwhale::Model::NonceStore->new($c);
isa_ok($ns, 'Angerwhale::Model::NonceStore');

my $challenge = Angerwhale::Challenge->new({uri => 'test://test'});
...
$challenge = Angerwhale::Challenge->new({uri => 'test://test'});
