...
my ( $before, $current, $after ) =
  $o->_split_articles( [@articles], { articles_per_page => 1 } );
...
my @date_after_10_articles =
  ( localtime( $time_sep * ( $num_articles - 10 ) ) )[ 5, 4, 3 ];
$date_after_10_articles[0] += 1900;
$date_after_10_articles[1] += 1;      # Jan = 0

my $per_page = 15;
( $before, $current, $after ) = $o->_split_articles(
    [@articles],
    {
